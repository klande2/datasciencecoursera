####################
##### Peer Assignment 1: Plot 1
####################

#### Download the data to a temp file and uncompress
...
#### Create a data frame.  Used read.csv after trying csv2 and fread
...
### Create the png
############
### NB - this creates the code in your wd. e.g. getwd()

png(file="plot2.png", width = 480, height = 480,bg="transparent")
plot(subdmdor$DateTime,subdmdor$Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab=" ")
dev.off()
